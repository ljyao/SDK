					...
					if (c != null) {
						...
						if (!TextUtils.isEmpty(user)) {
							if (user.startsWith(CTWAP)) {
								return is3G ? "ctwap" : "ctwap2G";
							} else if (user.startsWith(CTNET)) {
								return is3G ? "ctnet" : "ctnet2G";
							}
						}
					}
					c.close();
